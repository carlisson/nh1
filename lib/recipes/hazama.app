...
function APP_VERSION {
    ...
    echo "Hazama-$(_nh1app.ghversion krrr Hazama).AppImage"    
}
...
function APP_GET {
    ...
    AGver=$(_nh1app.ghversion krrr Hazama)

    $AGpre curl -o "Hazama-$AGver.AppImage" -L \
        "https://github.com/krrr/Hazama/releases/download/v$AGver/Hazama-x86_64.AppImage"
