...
APP_SITE="https://github.com/NicolasConstant/sengi"
...
function APP_VERSION {
    ...
    echo "Sengi-$(\
        curl -s https://api.github.com/repos/NicolasConstant/sengi/releases/latest | grep "tag_name" | \
        cut -d\" -f 4\
        )-linux.AppImage"
}
...
function APP_GET {
    ...
    $AGpre curl -O -L "https://github.com/NicolasConstant/sengi/releases/download/$(\
            curl -s https://api.github.com/repos/NicolasConstant/sengi/releases/latest | grep "tag_name" | \
            cut -d\" -f 4\
        )/Sengi-$(\
            curl -s https://api.github.com/repos/NicolasConstant/sengi/releases/latest | grep "tag_name" | \
