...
function APP_VERSION {
    ...
    echo "Mirage-v$(_nh1app.ghversion mirukana mirage)-x86_64.AppImage"
}
...
function APP_GET {
    ...
    AGver=$(_nh1app.ghversion mirukana mirage)

    $AGpre curl -O -L "https://github.com/mirukana/mirage/releases/download/v$AGver/Mirage-v$AGver-x86_64.AppImage"
}
